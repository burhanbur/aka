      	...
      	<div class="card">
          	<div class="card-header">
          		<div style="float: left;">
          			<a href="#" value="{{ route('create.activity') }}" class="btn btn-success modalCreate" title="Buat Kegiatan" data-toggle="modal" data-target="#modalCreate"><i class="fas fa-user-plus"></i> &nbsp;Tambah Kegiatan</a>
				...
				<table id="table" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="center">Jumlah Survey</th>
							<th class="center"></th>
						</tr>
					</thead>
				</table>
