      	...
      	<div class="card">
          	<div class="card-header">
          		<div style="float: left;">
          			<a href="#" value="{{ route('create.institution.major') }}" class="btn btn-success modalCreate" title="Buat Program Studi" data-toggle="modal" data-target="#modalCreate"><i class="fas fa-user-plus"></i> &nbsp;Tambah Program Studi</a>
          			
          		</div>
            	<h3 class="card-title text-primary" style="float: right;">
            		<i class="fas fa-user"></i> Daftar Program Studi
            	</h3>
        	</div>
				...
				<table id="table" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="center">Nama Program Studi</th>
